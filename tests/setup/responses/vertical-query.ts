...
export const verticalQueryResponseWithNlpFilters = {
  ...
  response: {
    businessId: 3350634,
    queryId: "9da068df-fd31-4f75-90b3-e0be900fe9f2",
    resultsCount: 4,
    results: [
      {
        data: {
      ...
      },
      {
        data: {
          ...
          headshot: {
            url: "http://a.mktgcdn.com/p/8a6ix28DnWPS4CrO0GTRs3WFjvlBdLAkTs8UqgXZdQI/400x400.jpg",
            width: 400,
            height: 400,
            sourceUrl: "http://a.mktgcdn.com/p/8a6ix28DnWPS4CrO0GTRs3WFjvlBdLAkTs8UqgXZdQI/400x400.jpg",
            thumbnails: [
              {
                url: "http://a.mktgcdn.com/p/8a6ix28DnWPS4CrO0GTRs3WFjvlBdLAkTs8UqgXZdQI/196x196.jpg",
                width: 196,
                height: 196
              }
            ]
