...
export function HelpArticlesCard(props: TrainerCardProps): JSX.Element {
  const { result } = props;
  ...
  const HADetails = FaqVertical.c_helpArticleRichText ? FaqVertical.c_helpArticleRichText : null; 
    ...
    <>
      <div className={'faq-block md:col-span-3 ' + trainer.id + ' ' + faqClass} >
        ...
        <div className={cssClasses.ctaButton + ' faq-content'}>
          ...
          <div className='HelpArticleDetail'>
            {HADetails}
          </div>
