export function renderSelectedLocation(name?: string, addressLine1?: string, addressLine2?: string, mainPhone?: string) {
  return (
      ...
      <div className="flex space-x-2 p-2">
        ...
        <div className="">
          ...
          <div className="flex flex-col">
            ...
            <span className="inline-flex font-body text-sm text-black">{mainPhone}</span>
          </div>
        </div>
      </div>
    </div>
